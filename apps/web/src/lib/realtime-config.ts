...
// 1. apps/web/.env         -> valor local real
// 2. apps/web/.env.example -> referencia compartida
// 3. No editar page.tsx para rotaciones normales de IP
export const REALTIME_SERVER_URL =
  process.env.NEXT_PUBLIC_REALTIME_URL?.trim() || DEFAULT_REALTIME_URL;
